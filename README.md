...
- ## 제가 하는 해킹 분야들은 아래와 같습니다.
  ...
  - ### Webhacking, Mobile Hacking, Smart Contract Hacking, Forensic (CERT, Network), Antivirus Framework Development, Security Architecture / Protocol Analysis, Artificial Intelligence Security (Machine Learning, LLM).
