...
### Smart Contract Hacking, Web3 (Defi) Security Software Development, Web3 (Defi) Secure Coding, Web3 (Defi) Fuzzing Tool Development, BlockChain Development, WebAssembly Security Software Development, Cryptography, Pwnable, Reversing, OS Kernel Exploit (Linux, Windows, Mac OS,...), Malware Analysis, Webhacking, Mobile Hacking, Cloud Hacking, Cloud Infra Security, Browser Exploit, Game Hacking, Embedded Hacking, Hardware Hacking, Car Hacking, Forensic, MITRE ATT&CK Analysis, Yara Rules, System Secure Coding, System Fuzzing Tool Development, Web Secure Coding, Web Fuzzing Tool Development, OS Fuzzing Tool Development, Mobile Application Development, OS Kernel Development, Operating System Development, Windows Software Development, WebAssembly Software Development, Front-end Development, Back-end Development, Windows Application Development, Windows Kernel Development, DOS Kernel Development, CERT, Pentesting, OSINT,... 
