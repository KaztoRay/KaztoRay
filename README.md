...
- 화이트해커 / 정보보안 전문가 / 악성코드 분석가 / 포렌식 분석가 (침해사고 분석가) / 인공지능 보안 개발자/ 윈도우 소프트웨어 개발자 / 운영체제 드라이버 개발자 (리눅스, 윈도우) / 시스템 소프트웨어 개발자 / 풀스택 개발자 / 임베디드 개발자 (로보틱스 (메카트로닉스) 개발자) / 인공지능 개발자 / 보안 소프트웨어 개발자 / 게임 보안 전문가 / 게임 개발자로 나아가는 Dreamer.    
