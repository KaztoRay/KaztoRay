...
### Pwnable, Reversing, OS Kernel Exploit (Linux, Windows, Mac OS,...), Browser Exploit, Haraware Hacking, Embedded Hacking, ICS Hacking, Car Hacking, OTA Security, SDV Security, Server Infra Security, Cloud Infra Security, Cryptography, Forensic, MITRE ATT&CK Analysis, Yara Rules, System Secure Coding, System Fuzzing Tool Development, OS Kernel Secure Coding, OS Kernel Fuzzing Tool Development, Hardware Secure Coding, Haraware Fuzzing Tool Development, Embedded Secure Coding, Embedded Fuzzing Tool Development, Haraware Software Development, Embedded Software Development,... 
