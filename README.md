...
- 다양한 다양한 취약점 분석, 악성코드 분석 및 인공지능 보안에 대해서 공부하고 연구하고 있는 화이트해커 &  악성코드 분석가 & 인공지능 개발자입니다.

- ## 제가 공부하는 분야들은 아래와 같습니다.

  - ### Pwnable, Fuzzing Test, Reversing, Malware Analysis, Forensic, Yara Rules, Artificial Intelligence Security, Cryptography.
