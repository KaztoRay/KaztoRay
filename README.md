...
<div align = "center">
 ...
 <h1> 💫 KaztoRay is White Hacker & Cyber System Security Expert & Malware Analyst & Security Solution Developer & Software Security Researcher & Connected Car Hacking & Game Hacking & Deep Learning / Machine Learning Security Programmer. 💫 </h1>

### 💫 안녕하세요 모의 해킹 및 자동차 시스템 해킹 및 IoT 보안 및 시스템 커널 취약점 분석 및 악성코드 분석 / 게임 해킹 분야를 공부하고 있으며, 시스템 보안 소프트웨어 개발 및 및 딥러닝과 머신러닝을 이용한 악성코드 분석 및 보안 소프트웨어 개발, 임베디드 보안 어플리케이션 등을 개발하고 있는 정보보안 전문가 & 인공지능 보안 전문가 KaztoRay입니다. 💫
