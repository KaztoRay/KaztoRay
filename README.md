...
- 다양한 악성코드 분석과 포너블에 대해서 공부하고 연구하고 있는 악성코드 분석가 & 화이트해커 & 보안 위협 분석가입니다.

- ## 제가 공부하는 분야들은 아래와 같습니다.
 
### Pwnable, Reversing, Malware Analysis, MITRE ATT&CK, PE/ELF (Execute) File Analysis, System Fuzzing, Yara Rules, Game Hacking. 
