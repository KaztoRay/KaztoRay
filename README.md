...
- ## 제가 하는 해킹 분야들은 아래와 같습니다.
  ...
  - ### Reversing, Malware Analysis, Forensic, Webhacking, Smart Contract Hacking, Mobile Forensic, Network Forensic, Cuckoo SandBox Malware Analysis, MITRE ATT&CK Analysis, YARA Rules, Zerotrust Network, IDS/IPS Security (Snort), Game Hacking, Web Fuzzing System, Artificial Intelligence Security, Cryptography, ISMS-P.
