...
### Webhacking, Black-Box Penetration Testing with PETS, Smart Contract Hacking, Mobile Application Hacking (IOS, Android,...), Artificial Intelligence Hacking, LLM Hacking, Artificial Intelligence Security Software Development, Machine Learning based Security Software Development, Deep Learning based Security Software Development, Reversing, Pwnable, OS Kernel Exploit (Linux, Windows,...), Malware Analysis, OS 0day & 1day Vulnerability Analysis, ARM Based System Hacking, Network Hacking, Embedded Hacking, Hardware Hacking, Forensic, Cryptography, Web Secure Coding, Web Fuzzing Tool Development, Web3 Secure Coding, Web3 Fuzzing Tool Development, Cloud Secure Coding, Cloud Fuzzing Tool Development, System Secure Coding, System Fuzzing Tool Development, Machine Learning based Secure Coding, Machine Learning based Fuzzing Tool Development, Deep Learning based Secure Coding, Deep Learning based Fuzzing Tool Development, Cloud Infra Security (AWS, Azure, GCP,...) Kubernetes Security Audit, Server Infra Security, Artificial Intelligence Development, Machine Learning Development, Deep Learning Development, LLM Development (LangChain), NLP Development, OS Kernel Development, Yocto based Embedded Linux Development, Embedded Development, Artificial Intelligence Development, Windows Kernel Software Development, Windows Software Development, Linux Software Development, Network Programming, Mobile Application Development, Mobile Secure Application Development, Front-end Development, Back-end Development, Smart Contract Development, Hyperledger Fabric Development,.....
