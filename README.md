...
<div align = "center">
 ...
 <h1> 💫 KaztoRay is White Hacker & Cyber Security Expert & Malware Analyst. 💫 </h1>
 

 ![venom](https://capsule-render.vercel.app/api?type=venom&height=200&text=Kazto%20is%20Malware%20Analyst.&fontSize=60&color=0:8871e5,100:358cd8&stroke=358cd8)
...
- 화이트해커 / 정보보안 전문가 / 침해사고 분석가 / 악성코드 분석가 / 정보보안 컨설턴트 / 보안 소프트웨어 개발자 / 게임 서버 & 클라이언트 개발자로 나아가는 Dreamer.

  - 최대한 많은 해킹 분야 및 취약점 분석 / 악성코드 분석 / 디지털 포렌식 분야 및 DDoS 공격 대응 분야를 끊임없이 배우고 접하려고 노력하고 있습니다.
