...
### Pwnable, Reversing, OS Kernel Exploit (Windows, Linux, Mac OS,...), Malware Analysis, Forensic, Shellcode Analysis, MITRE Att&ck Analysis, Yara Rules, Pentesting, Game Hacking, Hardware Hacking, Embedded Hacking, Artificial Intelligence Security, Security Software Development, Cryptography, System Secure Coding, System Fuzzing Tool Development, OS Fuzzing Tool Development, Operating System Development, Embedded Development, Windows OS Development,...
 
- 화이트 해커 / 모의해킹 전문가 / 정보보안 컨설턴트 / 보안 취약점 연구가 / 악성코드 분석가 / 침해사고 분석가 / 운영체제 개발자 / 임베디드 개발자 / 윈도우 소프트웨어 개발자로 나아가는 Dreamer.
   - 최대한 많은 모의 해킹 분야 및 윈도우 소프트웨어 개발, 운영체제 개발 분야를 끊임없이 배우고 접하려고 노력하고 있습니다.
