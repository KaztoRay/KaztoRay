...
- ## 제가 공부하는 분야들은 아래와 같습니다. 
  ...
  - ### Forensic (OS, Cloud, OSINT, Registry,...), Pwnable, Reversing, Game Hacking, Webhacking, Smart Contract Hacking, Mobile Hacking, Artificial Intelligence Security, Deep Learning / Machine Learning, Cryptography, Application Programming.
