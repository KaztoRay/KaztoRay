...
- 화이트해커 / 정보보안 전문가 / 운영체제 및 가상 컴퓨팅 환경 (Hyper-V) 취약점 분석가 / 인공지능 보안 전문가 / 게임 보안 전문가 / 인공지능 보안 개발자 / 운영체제 드라이버 개발자 (리눅스, 맥, 윈도우) / 운영체제 개발자 / 시스템 소프트웨어 개발자 / 인공지능 개발자 / 보안 소프트웨어 개발자, 임베디드 운영체제 & 하드웨어 개발자로 나아가는 Dreamer.    
