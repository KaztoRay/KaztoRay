...
- 화이트 해커 / 모의해킹 전문가 / 정보보안 컨설턴트 / 보안 취약점 연구가 / 악성코드 분석가 / 운영체제 커널 개발자 / ARM 기반 운영체제 커널 개발자 / 인공지능 보안 소프트웨어 개발자 / 포렌식 소프트웨어 개발자 / 게임 보안 소프트웨어 개발자 / 윈도우 보안 소프트웨어 개발자 / 윈도우 드라이버 보안 개발자 / 임베디드 소프트웨어 개발자 / 인공지능 소프트웨어 개발자 / 게임 서버 & 클라이언트 개발자로 나아가는 Dreamer.
