...
- ## 제가 하는 해킹 분야들은 아래와 같습니다.
  ...
  - ### WReversing, Pwnable, Malware Analysis, MITRE ATT&CK & Fileless Attack Analysis, Anti Shell Analysis, Forensic (CERT, Network), Computer Antivirus Software Development, Security Architecture / Protocol Analysis, Rootkit Analysis, Artificial Intelligence Security (Machine Learning, LLM).
<div align = "center">
